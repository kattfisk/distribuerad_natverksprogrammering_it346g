...
public abstract class GameEntity implements Serializable
{
	...
	{
		// TODO: consider adding some interpolation
		m_position.set((double)state.get("pos_x"), (double)state.get("pos_y"));
		m_speed.set((double)state.get("vel_x"), (double)state.get("vel_y"));
	}
